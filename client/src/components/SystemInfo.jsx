...
const SystemInfo = () => {
    return (
        <section style={{ padding: '4rem 2rem', background: 'black', borderTop: '1px solid white' }}>
            <div className="retro-container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '3rem' }}>
                    ...
                    {/* Tech Stack */}
                    <div>
                        <h4 style={{ borderBottom: '1px solid white', marginBottom: '1rem' }}>SYSTEM_ARCHITECTURE</h4>
                    ...
                    {/* Security */}
                     <div>
                        <h4 style={{ borderBottom: '1px solid white', marginBottom: '1rem' }}>DATA_SECURITY_PROTOCOL</h4>
                        <ul style={{ listStyle: 'none', padding: 0, fontSize: '0.9rem', color: '#ccc' }}>
                     ...
                     {/* Social Proof */}
                     <div>
                        <h4 style={{ borderBottom: '1px solid white', marginBottom: '1rem' }}>USER_FEEDBACK_LOGS</h4>
                        <div style={{ fontSize: '0.9rem', color: '#ccc', fontStyle: 'italic', marginBottom: '1rem' }}>
                            "Clear roadmap within minutes. System efficiency optimal." <br/>
                            <span style={{ color: '#4ade80' }}>-- Final Year Student</span>
                        </div>
                         <div style={{ fontSize: '0.9rem', color: '#ccc', fontStyle: 'italic' }}>
